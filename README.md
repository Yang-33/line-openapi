...
Below is a suggested "How to Contribute" section in English with an OSS-friendly tone:
...
Our employees update the schema based on the latest features and changes in our APIs.
